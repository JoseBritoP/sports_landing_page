    ...
    <>
      ...
      <section className="relative z-10 flex items-center h-full text-gray-100">
        <div className="w-5/6 mx-auto grid items-center grid-cols-1 lg:grid-cols-2 gap-2">
          ...
          <div className="space-y-5 w-4/5">
            ...
            <div className="flex items-center space-x-14">
              <div className="flex items-center space-x-2 mt-1 sm:mt-4">
                ...
                <p className="text-sm sm:text-lg text-white">March 20,2024</p>
              </div>
              <div className="flex items-center space-x-2 mt-1 sm:mt-4">
          ...
          {/* Play button */}
          {/* <div className="pt-5">
            <button onClick={showModalHandler} className="w-[10rem] lg:ml-auto h-[10rem] rounded-full bg-red-600 hover:bg-black transition-all duration-200 cursor-pointer sm:flex flex-col items-center justify-center hidden">
